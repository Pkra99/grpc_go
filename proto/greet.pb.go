...
func (x *NoPrams) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NoPrams) ProtoMessage() {}

func (x *NoPrams) ProtoReflect() protoreflect.Message {
	mi := &file_proto_greet_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use NoPrams.ProtoReflect.Descriptor instead.
func (*NoPrams) Descriptor() ([]byte, []int) {
...
var file_proto_greet_proto_goTypes = []any{
	(*NoPrams)(nil),       // 0: greet_service.NoPrams
...
var file_proto_greet_proto_depIdxs = []int32{
	...
	4, // 6: greet_service.GreetService.SayHelloFromClient:output_type -> greet_service.MessageList
